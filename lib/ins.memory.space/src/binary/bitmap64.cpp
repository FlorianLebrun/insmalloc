...
void ins::Bitmap64::print() {
   printf("bitmap%s\n", this->str().c_str());
}

std::string ins::Bitmap64::str() {
   char bitchars[64];
   for (int i = 0; i < 64; i++) {
...
const uint64_t ins::AlignedHierarchyBitmap64::cAlignedSelectionMask[7] = {
...
void ins::AlignedHierarchyBitmap64::print() {
...
void ins::BinaryHierarchyBitmap64::print() {
