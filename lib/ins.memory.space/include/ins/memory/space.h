...
extern"C" ins::ObjectHeader ins_new(size_t size);
extern"C" ins::ObjectHeader ins_new_unmanaged(ins::SchemaID schemaID);
extern"C" ins::ObjectHeader ins_new_managed(ins::SchemaID schemaID);
extern"C" void ins_delete(ins::ObjectHeader obj);
