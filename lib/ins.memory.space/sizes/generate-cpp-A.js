...
SizeClassTable ins::sizeClassTable;

const uint8_t ins::SizeClassTable::mapping_classids[${mapping_classids_length}] = {
${mapping_classids.join("\n")}
};

const SizeClassTable::MapSizeL2_t ins::SizeClassTable::mapping_size_L2[${c_max_class_size_L2}] = {
${mapping_size_L2.join("\n")}
};

ins::SizeClassTable::SizeClassTable() {
${classes_initializers.join("\n")}
}

address_t ins::SizeClassEntry::allocate(size_t target, MemoryContext* context) {
   return 0;
}
size_t ins::SizeClassEntry::size_max() {
   return 0;
}
