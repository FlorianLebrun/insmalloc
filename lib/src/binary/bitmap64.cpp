...
const uint64_t AlignedHierarchyBitmap64::cAlignedSelectionMask[7] = {
...
void AlignedHierarchyBitmap64::print() {
...
void BinaryHierarchyBitmap64::print() {
