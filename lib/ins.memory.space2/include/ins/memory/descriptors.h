...
namespace ins {
   ...
   union RegionEntry {
      ...
      static const uint8_t cOpaqueBits = 0x01;
      static const uint8_t cDescriptorBits = 0x03;
      uint8_t bits;
      struct {
   ...
   struct sDescriptorAllocator : sRegion {
      ...
      static sDescriptorAllocator* New(size_t countL2);
   ...
   private:
      sDescriptorAllocator(uint32_t countL2) {
